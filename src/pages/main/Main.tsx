...
function Main() {
  ...
  const renderTabs = () => (
    <Tab.Panels className="h-full mx-auto flex flex-1 overflow-y-auto shadow-t-xl bg-gray-100">
      <Tab.Panel className="w-full h-full flex overflow-x-none overflow-y-auto flex flex-col gap-12 px-4 py-8 s">
